...
class SupabaseUserProfileModel with _$SupabaseUserProfileModel {
  const factory SupabaseUserProfileModel({
    ...
    @Default(false) @JsonKey(name: 'is_email_verified') bool isEmailVerified,
    @Default(false) @JsonKey(name: 'is_phone_verified') bool isPhoneVerified,
    @Default('public') @JsonKey(name: 'privacy_level') String privacyLevel,
    @Default([]) List<String> interests,
    @Default({}) Map<String, dynamic> preferences,
    @Default({}) @JsonKey(name: 'social_links') Map<String, dynamic> socialLinks,
