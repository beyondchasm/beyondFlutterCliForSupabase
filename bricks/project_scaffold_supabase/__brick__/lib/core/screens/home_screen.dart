              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This app is powered by Supabase, providing PostgreSQL database, real-time subscriptions, and secure authentication.',
                      style: ThemeTextStyles.bodyMedium.copyWith(
                        color: Colors.grey[600],
                      ),
                    ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          '1. Configure Supabase in supabase_config.dart\n'
