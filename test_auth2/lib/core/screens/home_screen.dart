              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This app uses REST API for backend communication, providing flexibility and compatibility with various server implementations.',
                      style: ThemeTextStyles.bodyMedium.copyWith(
                        color: Colors.grey[600],
                      ),
                    ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          '1. Configure your API endpoints in environment.dart\n'
          '2. Set your baseUrl and API keys\n'
